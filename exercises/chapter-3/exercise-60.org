...
So that we could reuse the implementation of the multiply series, I have implemented it in a reusable module, which could be found [[file:stream-series.org][here]].
