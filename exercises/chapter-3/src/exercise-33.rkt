;; [[file:../exercise-33.org::*Solution][Solution:1]]
#lang sicp
;; Solution:1 ends here

;; [[file:../exercise-33.org::*Connectors][Connectors:1]]
...
;; [[file:../exercise-33.org::*Connectors][Connectors:2]]
...
;; [[file:../exercise-33.org::*Connectors][Connectors:3]]
...
;; [[file:../exercise-33.org::*Constraints][Constraints:1]]
...
;; [[file:../exercise-33.org::*Constraints][Constraints:2]]
...
;; [[file:../exercise-33.org::*Constraints][Constraints:3]]
...
;; [[file:../exercise-33.org::*Constraints][Constraints:4]]
...
;; [[file:../exercise-33.org::*Constraints][Constraints:5]]
...
;; [[file:../exercise-33.org::*Average Constraint][Average Constraint:1]]
(define (averager a b c)
  (let ([w (make-connector)]
    ...
    (multiplier w x c)
    'ok))
;; Average Constraint:1 ends here

;; [[file:../exercise-33.org::*Testing][Testing:1]]
(define (test-a)
...
;; [[file:../exercise-33.org::*Testing][Testing:2]]
(define (test-b)
(let ([a (make-connector)]
        [b (make-connector)]
        [c (make-connector)])
...
;; [[file:../exercise-33.org::*Testing][Testing:3]]
(test-a)
(test-b)
;; Testing:3 ends here
