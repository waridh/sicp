...
#+name: 3.9-rec-1
#+begin_src plantuml :exports file :file ./images/3.9-recursive-1.png
@startuml
...
#+name: 3.9-rec-2
#+begin_src plantuml :exports file :file ./images/3.9-recursive-2.png
@startuml
rectangle "Global Environment" as glob_env {
        rectangle "factorial" as fact_proc
}
...
#+name: 3.9-rec-3
#+begin_src plantuml :exports file :file ./images/3.9-recursive-3.png
@startuml
rectangle "Global Environment" as glob_env {
        rectangle "factorial" as fact_proc
}
...
#+name: 3.9-rec-4
#+begin_src plantuml :exports file :file ./images/3.9-recursive-4.png
@startuml
rectangle "Global Environment" as glob_env {
        rectangle "factorial" as fact_proc
}
...
#+name: 3.9-rec-5
#+begin_src plantuml :exports file :file ./images/3.9-recursive-5.png
@startuml
rectangle "Global Environment" as glob_env {
        rectangle "factorial" as fact_proc
}
...
#+name: 3.9-rec-6
#+begin_src plantuml :exports file :file ./images/3.9-recursive-6.png
@startuml
rectangle "Global Environment" as glob_env {
        rectangle "factorial" as fact_proc
}
...
#+name: 3.9-rec-7
#+begin_src plantuml :exports file :file ./images/3.9-recursive-7.png
@startuml
rectangle "Global Environment" as glob_env {
        rectangle "factorial" as fact_proc
}
...
#+name: 3.9-iter-1
#+begin_src plantuml :exports file :file ./images/3.9-iterative-1.png
@startuml
rectangle "Global Environment" as glob_env {
        rectangle "factorial" as fact_proc
...
#+name: 3.9-iter-2
#+begin_src plantuml :exports file :file ./images/3.9-iterative-2.png
@startuml
rectangle "Global Environment" as glob_env {
        rectangle "factorial" as fact_proc
        rectangle "fact-iter" as fact_iter_proc
...
#+name: 3.9-iter-3
#+begin_src plantuml :exports file :file ./images/3.9-iterative-3.png
@startuml
rectangle "Global Environment" as glob_env {
        rectangle "factorial" as fact_proc
        rectangle "fact-iter" as fact_iter_proc
...
#+name: 3.9-iter-4
#+begin_src plantuml :exports file :file ./images/3.9-iterative-4.png
@startuml
rectangle "Global Environment" as glob_env {
        rectangle "factorial" as fact_proc
        rectangle "fact-iter" as fact_iter_proc
...
#+name: 3.9-iter-5
#+begin_src plantuml :exports file :file ./images/3.9-iterative-5.png
@startuml
rectangle "Global Environment" as glob_env {
        rectangle "factorial" as fact_proc
        rectangle "fact-iter" as fact_iter_proc
